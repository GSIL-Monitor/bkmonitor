...
if __name__ == '__main__':
    ...
    mm = Mailer()
    #mm.sendemail('lugf@mail.sustc.edu.cn', mailto_list, "text mail", "Hi it's Max, this is a test maill-----1", "<h2>test html content</h2>", attachment='/Users/mmuunn/Documents/Works/issue_report/pp.pdf', listImagePath=image_list)
    mm.sendemail('lugf@mail.sustc.edu.cn', mailto_list, "text mail", "Hi it's Max, this is a test maill-----1")